...
> the internal **Nexus** project, and — with Claude Code now in the picture — Helix itself is
...
| **Nexus** | Internal project informing the new emerging design language (§9, §12) ✅ |
...
- **Design-system redesign (supersedes prior "Helix adoption" narrative — see §9):** the team is
  ...
  internal **Nexus** project. Notably, EHSQ-E may **inform the next generation of Helix**
